...
export default function BlogDetailHero({ blog }) {
  ...
  return (
    <div className="w-full max-w-screen-2xl mx-auto px-margin-mobile md:px-margin-desktop mb-16">
      <div className="w-full h-[300px] md:h-[500px] overflow-hidden rounded-xl border border-outline-variant shadow-2xl relative bg-black flex items-center justify-center">
        <img 
