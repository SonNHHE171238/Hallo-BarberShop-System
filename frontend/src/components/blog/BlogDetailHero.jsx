...
export default function BlogDetailHero({ blog }) {
  ...
  return (
    <div className="w-full max-w-[800px] mx-auto px-margin-mobile md:px-0 mb-16">
      <div className="w-full overflow-hidden rounded-xl shadow-2xl relative flex items-center justify-center">
        <img 
