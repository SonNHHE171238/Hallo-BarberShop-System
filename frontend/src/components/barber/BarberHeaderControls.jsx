...
export default function BarberHeaderControls({ profile, onToggleAvailability }) {
  ...
  return (
    <section className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 border-b border-outline-gold pb-8">
      <div>
        ...
        <h1 className="font-display-lg text-headline-lg-mobile md:text-display-lg text-on-surface serif-heading">Chào Buổi Sáng, {name}.</h1>
      </div>
