    ...
    return (
        <section className="rounded-3xl border border-outline-gold bg-surface-container-low p-5 shadow-2xl shadow-black/5 flex flex-col h-full max-h-[800px]">
            <div className="mb-4 flex items-center justify-between gap-4">
                ...
                <span className="text-label-sm text-on-surface-variant bg-surface-container px-3 py-1 rounded-full">{barbers.length} thợ</span>
            </div>
            <div className="mb-4">
            ...
            <div className="space-y-3 overflow-y-auto flex-grow pr-2 scrollbar-thin scrollbar-thumb-primary/20">
                {displayBarbers.length === 0 ? (
                    <div className="text-center py-10 text-on-surface-variant">Không tìm thấy thợ cắt tóc nào.</div>
                ) : (
