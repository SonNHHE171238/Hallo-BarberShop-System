...
export default function AdminOrderDetailPage({
  ...
  return (
    <div className="max-w-[1400px] mx-auto w-full space-y-10 text-on-surface">
      ...
      {/* Status Update Modal (giữ nguyên cho các update khác) */}
      {isModalOpen && (
        ...
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
          ...
          <div className="relative bg-surface-container border border-green-500/30 max-w-md w-full p-8 shadow-2xl rounded-xl text-center">
            ...
            <div className="flex gap-4 justify-center">
              <button className="px-6 py-2 text-[12px] font-label-md uppercase tracking-widest text-outline hover:text-white transition-colors" onClick={() => setIsCodModalOpen(false)}>Hủy</button>
