      ...
      <div className="w-full max-w-6xl mx-auto flex flex-col h-full">
        <div className="flex-1 overflow-y-auto pr-2 custom-scrollbar">
          <header className="flex flex-col md:flex-row justify-between items-start md:items-center mb-6 gap-4">
            <div>
              <a href="/staff/bookings" className="text-xs uppercase tracking-wider text-gray-400 hover:text-white flex items-center gap-2 mb-2">
          ...
          <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-xl p-4 flex items-center gap-4 min-w-[200px] justify-between">
            <div className="flex items-center gap-2 text-gray-400">
              ...
              <span className="text-xs uppercase tracking-wider font-medium">Giờ hẹn</span>
            </div>
