...
const validateBookingStatusUpdate = (booking, newStatus, userRole = 'customer') => {
  ...
  const validTransitions = {
    admin: {
      [BOOKING_STATUS.PENDING]: [BOOKING_STATUS.CONFIRMED, BOOKING_STATUS.CANCELLED, BOOKING_STATUS.NO_SHOW],
      [BOOKING_STATUS.CONFIRMED]: [BOOKING_STATUS.PENDING, BOOKING_STATUS.COMPLETED, BOOKING_STATUS.CANCELLED, BOOKING_STATUS.NO_SHOW],
      [BOOKING_STATUS.CANCELLED]: [],
      [BOOKING_STATUS.COMPLETED]: [],
      [BOOKING_STATUS.NO_SHOW]: []
    },
